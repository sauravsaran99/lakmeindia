...
let arr = [{"image": "https://cdn.shopify.com/s/files/1/0014/3514/0183/products/Hero_Bundle-_1_1_500x.jpg?v=1617893040", "name": "Lakme BLUSH AND GLOW SHEET MASK VALUE SET OF 10", "currentPrice": "599", "oldPrice": "1,000", "discoutPrice": "40% off", "isSoldOut": null},
...
div5.setAttribute('class', 'productbox');
div5.textContent = elm.currentPrice;
sum = elm.currentPrice
// console.log(typeof(Number(elm.currentPrice)))
// var div6 = document.createElement('div');
// div6.setAttribute('class', 'productbox');
document.querySelector('.box2').append(section2);


    section2.append(div1, div2, div4, div5);
